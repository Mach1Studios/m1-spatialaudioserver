    ...
    <div class="field middle-align">
      <nav class="no-padding">
        <label class="switch">
          <input
            type="checkbox"
            :checked="forcestandard"
            @click="forcestandard = !forcestandard"
          >
          <span />
        </label>
        <div class="checkbox">
      ...
      <div class="flex-item scroll">
        <table class="table-uploader flex-item">
          <thead>
            ...
            <th v-if="typeOfFiles === 'standard' && !forcestandard">
          ...
          <tbody>
            <tr v-for="(item, index) in files" :key="item">
              ...
              <td>
                <FormSelect
                  v-if="typeOfFiles === 'standard' && !forcestandard"
